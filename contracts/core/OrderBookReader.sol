...
contract OrderBookReader {
    ...
    /// @notice Get increase orders
    /// @param _orderBookAddress Address of the order book
    /// @param _account Address of the account
    /// @param _indices Indices of the orders to get
