...
describe("Vault.liquidateLongPosition", function () {
  ...
  it("liquidate long", async () => {
    ...
    expect(await vlpManager.getAumInUsdv(false)).eq("99064997000000000000"); // 99.064997
    expect(await vlpManager.getAumInUsdv(true)).eq("101418485000000000000"); // 101.418485
    ...
    expect(await vlpManager.getAumInUsdv(false)).eq("101522097000000000000"); // 101.522097
    expect(await vlpManager.getAumInUsdv(true)).eq("114113985000000000000"); // 114.113985
