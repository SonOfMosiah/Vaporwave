...
describe("Vault.decreaseLongPosition", function () {
  ...
  it("decreasePosition long", async () => {
    ...
    expect(await vlpManager.getAumInUsdv(false)).eq("103917746000000000000"); // 103.917746
    expect(await vlpManager.getAumInUsdv(true)).eq("107058666000000000000"); // 107.058666
  ...
  it("decreasePosition long aum", async () => {
    ...
    expect(await vlpManager.getAumInUsdv(false)).eq("7227000000000000000000"); // 7227
    expect(await vlpManager.getAumInUsdv(true)).eq("7227000000000000000000"); // 7227
    ...
    expect(await vlpManager.getAumInUsdv(false)).eq("7227000000000000000250"); // 7227.00000000000000025
    expect(await vlpManager.getAumInUsdv(true)).eq("7227000000000000000250"); // 7227.00000000000000025
