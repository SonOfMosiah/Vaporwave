...
describe("Vault.liquidateShortPosition", function () {
  ...
  it("liquidate short", async () => {
    ...
    expect(await vlpManager.getAumInUsdv(true)).eq("104780000000000000000"); // 104.78
  ...
  it("automatic stop-loss", async () => {
    ...
    expect(await vlpManager.getAumInUsdv(false)).eq("1000599600000000000000"); // 1000.5996
    ...
    expect(await vlpManager.getAumInUsdv(true)).eq("1090599600000000000000"); // 1090.5996
  ...
  it("global AUM", async () => {
    ...
    expect(await vlpManager.getAumInUsdv(true)).eq("1125599600000000000000"); // 1125.5996
    ...
    expect(await vlpManager.getAumInUsdv(true)).eq("1093599600000000000000"); // 1093.5996
